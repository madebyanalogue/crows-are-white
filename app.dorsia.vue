...
const initialRoutePath = useState('dorsia_initialRoutePath', () => '')
const route = useRoute()

if (process.server) {
  initialRoutePath.value = route.path
}
if (process.client && !initialRoutePath.value) {
...
useHead(() => {
  ...
  if (activeDescription.value) {
    meta.push({
      name: 'description',
      content: activeDescription.value,
    })
  }
  ...
  if (activeDescription.value) {
    meta.push({ property: 'og:description', content: activeDescription.value })
  }
  ...
  if (activeDescription.value) {
    meta.push({ name: 'twitter:description', content: activeDescription.value })
  }

  if (activeShareImage.value) {
    meta.push({ name: 'twitter:image', content: activeShareImage.value })
  }
