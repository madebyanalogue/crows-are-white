...
function pageSectionProjection() {
  return `{
    ...
    contactInformationPaddingTop,
    contactInformationPaddingBottom,
    ...
    newsletterLayout,
    newsletterMapTitle,
    newsletterMapSubscriberCount,
    newsletterMapBackgroundImage ${imageProjection},
    newsletterMapLightStyle,
    newsletterMapZoomControls,
    ...
    reflectionsMapSubscriberCount,
    reflectionsMapBackgroundImage ${imageProjection},
    reflectionsMapLightStyle,
    reflectionsMapZoomControls,
    reflectionsMapPostsLayout,
    reflectionsIntro,
    reflectionsLayout,
