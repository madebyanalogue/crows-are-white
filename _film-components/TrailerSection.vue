...
<template>
  <section id="trailer" class="scroll-mt-28">
    ...
    <button
      type="button"
      class="group relative block w-full overflow-hidden border border-wire-ink bg-black text-left"
    ...
    >
      ...
      >
        <span
          class="flex h-20 w-20 items-center justify-center rounded-full border border-white bg-black/50 text-white transition-transform group-hover:scale-105"
        >
